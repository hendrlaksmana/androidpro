...
public class CustomAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.txtName.setText(dataModel.getItem_name());
        viewHolder.txtPrice.setText(dataModel.getItem_price());
        viewHolder.Image.setImageResource(dataModel.getItem_image());
